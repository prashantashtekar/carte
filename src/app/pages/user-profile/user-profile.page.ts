...
export class UserProfilePage implements OnInit, OnDestroy {
  ...
  setUserProfileForm() {
   ...
   this.userProfileForm.controls['phoneNumber'].setValue(this.userProfile.phoneNumber);
    this.userProfileForm.controls['address'].setValue(this.userProfile.address);
  }
  ...
  updateUserProfile() {
    ...
    //TODO: Check for email and phone no 
